...
from videollava.model.language_model.sparse_llava_llama import LlavaLlamaDynamicForCausalLM
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda", dynamic_sparse=True, **kwargs):
    ...
    if 'llava' in model_name.lower():
        ...
        if 'lora' in model_name.lower() and model_base is not None:
            ...
            if 'mpt' in model_name.lower():
                ...
                if dynamic_sparse:
                    model = LlavaLlamaDynamicForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, **kwargs)
                else:
