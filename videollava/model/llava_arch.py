...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_sparse_inputs_labels_for_multimodal(
        ...
        if _position_ids is None:
            position_ids = None
        self.image_shape = torch.stack(image_features).shape[0] * torch.stack(image_features).shape[1]
        ...
        return None, position_ids, attention_mask, past_key_values, new_input_embeds, new_labels, self.image_shape, token_length_list, pre_prompt_length_list
